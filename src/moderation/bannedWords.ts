export const bannedWords = {
    // Insultos generales (tono ligero-medio)
    general: [
    ...
    // Términos discriminatorios genéricos
    discriminatory: [
      // Aquí NO se añaden términos dirigidos a grupos concretos
      // Solo expresiones genéricas o neutras que se usan con fin de discriminación
